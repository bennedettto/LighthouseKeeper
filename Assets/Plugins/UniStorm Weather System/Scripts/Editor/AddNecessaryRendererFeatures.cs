...
namespace UniStorm
{
    public class AddNecessaryRendererFeatures
    {
        ...
        private static void AddNecessaryRendererFeaturesInternal()
        {
            ...
            if (!featuresFound.Contains(ShaderConstants.cloudShadowFeatureName))
            {
                ...
                cloudShadowFeature.name = ShaderConstants.cloudShadowFeatureName;
            ...
            if (!featuresFound.Contains(ShaderConstants.atmosphericFogFeatureName))
            {
                ...
                atmosphericFogFeature.name = ShaderConstants.atmosphericFogFeatureName;
            ...
            if (!featuresFound.Contains(ShaderConstants.sunShaftsFeatureName))
            {
                //add sun shafts feature
                UniStormSunShaftsFeature sunShaftsFeature = ScriptableObject.CreateInstance<UniStormSunShaftsFeature>();
                sunShaftsFeature.name = ShaderConstants.sunShaftsFeatureName;
            ...
            if (!featuresFound.Contains(ShaderConstants.moonShaftsFeatureName))
            {
                ...
                moonShaftsFeature.name = ShaderConstants.moonShaftsFeatureName;
            ...
            if (!featuresFound.Contains(ShaderConstants.unistormCloudsRendererFeatureName))
            {
                ...
                unistormCloudRendererFeature.name = ShaderConstants.unistormCloudsRendererFeatureName;
