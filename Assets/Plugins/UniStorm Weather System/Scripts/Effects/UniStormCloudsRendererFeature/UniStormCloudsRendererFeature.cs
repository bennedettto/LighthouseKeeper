                ...
                using (new ProfilingScope(cmd, m_ProfilingSampler))
                {
                    ...
                    switch (m_UniStormClouds.CloudShadowsTypeRef)
                    {
                        ...
                        case UniStormClouds.CloudShadowsType.Simulated:
                            ...
                            m_UniStormClouds.shadowsBuildingMaterial.SetFloat(ShaderConstants.uCloudsCoverage, m_UniStormClouds.skyMaterial.GetFloat("_uCloudsCoverage"));
                            m_UniStormClouds.shadowsBuildingMaterial.SetFloat(ShaderConstants.uCloudsCoverageBias, m_UniStormClouds.skyMaterial.GetFloat("_uCloudsCoverageBias"));
                            m_UniStormClouds.shadowsBuildingMaterial.SetFloat(ShaderConstants.uCloudsDensity, m_UniStormClouds.skyMaterial.GetFloat("_uCloudsDensity"));
                            m_UniStormClouds.shadowsBuildingMaterial.SetFloat(ShaderConstants.uCloudsDetailStrength, m_UniStormClouds.skyMaterial.GetFloat("_uCloudsDetailStrength"));
                            m_UniStormClouds.shadowsBuildingMaterial.SetFloat(ShaderConstants.uCloudsBaseEdgeSoftness, m_UniStormClouds.skyMaterial.GetFloat("_uCloudsBaseEdgeSoftness"));
                            m_UniStormClouds.shadowsBuildingMaterial.SetFloat(ShaderConstants.uCloudsBottomSoftness, m_UniStormClouds.skyMaterial.GetFloat("_uCloudsBottomSoftness"));
                            m_UniStormClouds.shadowsBuildingMaterial.SetFloat(ShaderConstants.uSimulatedCloudAlpha, m_UniStormClouds.cloudTransparency);
                    ...
                    m_UniStormClouds.cloudsMaterial.SetTexture(ShaderConstants.mainTex, m_UniStormClouds.fullCloudsBuffer[m_UniStormClouds.fullBufferIndex ^ 1]);
                }
