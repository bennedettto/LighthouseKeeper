...
namespace UniStorm.Utility
{
    public class LightningSystem : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            m_LightningMaterial.SetColor(ShaderConstants.tintColor, UniStormSystem.Instance.LightningColor);
            m_LightningColor = m_LightningMaterial.GetColor(ShaderConstants.tintColor);
        ...
        void GeneratePoints()
        {
            ...
            m_LightningMaterial.SetTextureOffset(ShaderConstants.mainTex, new Vector2(offset, 0));
        ...
        void Update()
        {
            if (AnimateLight)
            {
                ...
                Shader.SetGlobalFloat(ShaderConstants.uLightning, LightningLightSource.intensity * 0.3f);
        ...
        IEnumerator DrawLightning()
        {
            ...
            if (UniStormSystem.Instance.LightningStrikes == UniStormSystem.EnableFeature.Enabled)
            {
                ...
                while (Generated)
                {
                    ...
                    m_LightningMaterial.SetColor(ShaderConstants.tintColor, TempColor2);
                    ...
                    if (m_FlashTimer >= m_FlashSeconds)
                    {
                        ...
                        m_LightningMaterial.SetColor(ShaderConstants.tintColor, TempColor);
            ...
            m_LightningMaterial.SetColor(ShaderConstants.tintColor, C);
        }
