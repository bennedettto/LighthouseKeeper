...
namespace UniStorm
{
    public class UniStormSystem : MonoBehaviour
    {
        ...
        public bool TimeFoldout = true, DateFoldout = true, TimeSoundsFoldout = true,
        ...
        static readonly int SHADER_distantCloudUpdateSpeed = Shader.PropertyToID("_DistantCloudUpdateSpeed");
        static readonly int SHADER_cloudMarchSteps = Shader.PropertyToID("CLOUD_MARCH_STEPS");
        static readonly int SHADER_distantCloudMarchSteps = Shader.PropertyToID("DISTANT_CLOUD_MARCH_STEPS");
        static readonly int SHADER_uCloudsCoverage = Shader.PropertyToID("_uCloudsCoverage");
        static readonly int SHADER_mainTex = Shader.PropertyToID("_MainTex");
        static readonly int SHADER_moonBrightness = Shader.PropertyToID("_MoonBrightness");
        static readonly int SHADER_moonColor = Shader.PropertyToID("_MoonColor");
        static readonly int SHADER_uWorldSpaceCameraPos = Shader.PropertyToID("_uWorldSpaceCameraPos");
        static readonly int SHADER_skyTint = Shader.PropertyToID("_SkyTint");
        static readonly int SHADER_atmosphereThickness = Shader.PropertyToID("_AtmosphereThickness");
        static readonly int SHADER_nightSkyTint = Shader.PropertyToID("_NightSkyTint");
        static readonly int SHADER_uCloudsAmbientColorTop = Shader.PropertyToID("_uCloudsAmbientColorTop");
        static readonly int SHADER_uCloudsAmbientColorBottom = Shader.PropertyToID("_uCloudsAmbientColorBottom");
        static readonly int SHADER_uSunColor = Shader.PropertyToID("_uSunColor");
        static readonly int SHADER_uFogColor = Shader.PropertyToID("_uFogColor");
        static readonly int SHADER_uAttenuation = Shader.PropertyToID("_uAttenuation");
        static readonly int SHADER_playerY = Shader.PropertyToID("_PlayerY");
        static readonly int SHADER_sunColor = Shader.PropertyToID("_SunColor");
        static readonly int SHADER_useUniStormFog = Shader.PropertyToID("_UseUniStormFog");
        static readonly int SHADER_fogColor = Shader.PropertyToID("_FogColor");
        static readonly int SHADER_sunControl = Shader.PropertyToID("_SunControl");
        static readonly int SHADER_moonControl = Shader.PropertyToID("_MoonControl");
        static readonly int SHADER_sunVector = Shader.PropertyToID("_SunVector");
        static readonly int SHADER_moonVector = Shader.PropertyToID("_MoonVector");
        static readonly int SHADER_sunIntensity = Shader.PropertyToID("_SunIntensity");
        static readonly int SHADER_moonIntensity = Shader.PropertyToID("_MoonIntensity");
        static readonly int SHADER_uHorizonColorFadeStart = Shader.PropertyToID("_uHorizonColorFadeStart");
        static readonly int SHADER_uHorizonColorFadeEnd = Shader.PropertyToID("_uHorizonColorFadeEnd");
        static readonly int SHADER_uHorizonFadeStart = Shader.PropertyToID("_uHorizonFadeStart");
        static readonly int SHADER_uHorizonFadeEnd = Shader.PropertyToID("_uHorizonFadeEnd");
        static readonly int SHADER_uSunFadeEnd = Shader.PropertyToID("_uSunFadeEnd");
        static readonly int SHADER_uCloudAlpha = Shader.PropertyToID("_uCloudAlpha");
        static readonly int uCloudsBottom = Shader.PropertyToID("_uCloudsBottom");
        static readonly int SHADER_uCloudsHeight = Shader.PropertyToID("_uCloudsHeight");
        static readonly int SHADER_wetnessStrength = Shader.PropertyToID("_WetnessStrength");
        static readonly int SHADER_snowStrength = Shader.PropertyToID("_SnowStrength");
        static readonly int SHADER_lightIntensity = Shader.PropertyToID("_LightIntensity");
        static readonly int SHADER_innerColor = Shader.PropertyToID("_InnerColor");
        static readonly int SHADER_outerColor = Shader.PropertyToID("_OuterColor");
        static readonly int SHADER_uCloudsBaseEdgeSoftness = Shader.PropertyToID("_uCloudsBaseEdgeSoftness");
        static readonly int SHADER_uCloudsBottomSoftness = Shader.PropertyToID("_uCloudsBottomSoftness");
        static readonly int SHADER_uCloudsDetailStrength = Shader.PropertyToID("_uCloudsDetailStrength");
        static readonly int SHADER_uCloudsDensity = Shader.PropertyToID("_uCloudsDensity");
        static readonly int SHADER_uCloudsCoverageBias = Shader.PropertyToID("_uCloudsCoverageBias");
        static readonly int SHADER_fogBlendHeight = Shader.PropertyToID("_FogBlendHeight");
        static readonly int SHADER_opaqueY = Shader.PropertyToID("_OpaqueY");
        static readonly int SHADER_transparentY = Shader.PropertyToID("_TransparentY");
        ...
        void InitializeUniStorm()
        {
            ...
            m_EffectsTransform.transform.localRotation = Quaternion.identity;
        ...
        void FollowPlayer()
        {
            m_MoonLight.transform.position = m_SunLight.transform.position = PlayerTransform.position;
        }
        ...
        public void MoveSun()
        {
            if (UseTimeOfDayUpdateControl == UseTimeOfDayUpdateSeconds.Yes)
            {
                ...
                {
                    m_CelestialAxisTransform.localRotation = Quaternion.Euler(m_TimeFloat * 360 - 100, SunRevolution, 180);
        ...
        void Update()
        {
            ...
            if (UniStormInitialized)
            {
                ...
                if (CustomizeQuality == CustomizeQualityEnum.Yes &&
                    UpdateMarchStepsDuringRuntime == EnableFeature.Enabled && CloudQuality == CloudQualityEnum.Ultra)
                {
                    m_CloudDomeMaterial.SetFloat(SHADER_distantCloudUpdateSpeed, ConvergenceSpeed);
                    Shader.SetGlobalFloat(SHADER_cloudMarchSteps, NearMarchSteps);
                    Shader.SetGlobalFloat(SHADER_distantCloudMarchSteps, DistantMarchSteps);
                ...
                {
                    if (CurrentWeatherType.CloudLevel == WeatherType.CloudLevelEnum.MostlyCloudy ||
                        CurrentWeatherType.CloudLevel == WeatherType.CloudLevelEnum.Cloudy)
                    {
                        m_LightningTimer += Time.deltaTime;

                        //Only create a lightning strike if the clouds have fully faded in
                        if (m_LightningTimer >= m_LightningSeconds &&
                            m_CloudDomeMaterial.GetFloat(SHADER_uCloudsCoverage) >= 0.5f)
                        {
                            m_UniStormLightningSystem.LightningCurve =
                                LightningFlashPatterns[Random.Range(0, LightningFlashPatterns.Count)];
            ...
            {
                if (GetPlayerAtRuntime == EnableFeature.Enabled && !UniStormInitialized)
                {
        ...
        {
            m_TimeFloat = (hours * 60 + minutes) / 1440f;
            TimeOfDayUpdateTimer = 0;
        }
        ...
        void TransitionWeather()
        {
            ...
            //Clouds
            if (m_CloudDomeMaterial.GetFloat(SHADER_uCloudsCoverage) < m_ReceivedCloudValue)
            {
        ...
        void CalculateMoonPhase()
        {
            if (MoonPhaseList.Count > 0)
            {
                ...
                m_MoonPhaseMaterial.SetTexture(SHADER_mainTex, MoonPhaseList[MoonPhaseIndex].MoonPhaseTexture);
                m_MoonRenderer.material = m_MoonPhaseMaterial;
                m_MoonPhaseMaterial.SetFloat(SHADER_moonBrightness, MoonBrightness);
                MoonPhaseIntensity = MoonPhaseList[MoonPhaseIndex].MoonPhaseIntensity;
                m_MoonPhaseMaterial.SetColor(SHADER_moonColor, MoonPhaseColor);
            }
        }
        ...
        void UpdateColors()
        {
            ...
            m_StarsMaterial.SetVector(SHADER_uWorldSpaceCameraPos, PlayerCamera.transform.position);
            m_SkyBoxMaterial.SetColor(SHADER_skyTint, SkyColor.Evaluate(m_TimeFloat));
            m_SkyBoxMaterial.SetFloat(SHADER_atmosphereThickness, AtmosphereThickness.Evaluate(m_TimeFloat * 24));
            m_SkyBoxMaterial.SetColor(SHADER_nightSkyTint, SkyTintColor.Evaluate(m_TimeFloat));
            m_CloudDomeMaterial.SetColor(SHADER_uCloudsAmbientColorTop, CloudLightColor.Evaluate(m_TimeFloat));
            m_CloudDomeMaterial.SetColor(SHADER_uCloudsAmbientColorBottom, CloudBaseColor.Evaluate(m_TimeFloat));
            m_CloudDomeMaterial.SetColor(SHADER_uSunColor, SunColor.Evaluate(m_TimeFloat));
            Color currentFogColor = FogColor.Evaluate(m_TimeFloat);
            m_CloudDomeMaterial.SetVector(SHADER_uFogColor, new Vector4(currentFogColor.r, currentFogColor.g, currentFogColor.b, CurrentFogAmount));
            m_CloudDomeMaterial.SetFloat(SHADER_uAttenuation, SunAttenuationCurve.Evaluate(m_TimeFloat * 24) * SunAttenuationMultipler);
            ...
            SunObjectMaterial.SetFloat(SHADER_playerY, PlayerTransform.position.y);
            SunObjectMaterial.SetColor(SHADER_sunColor, SunSpotColor.Evaluate(m_TimeFloat));
            ...
            m_MoonPhaseMaterial.SetFloat(SHADER_moonBrightness, MoonObjectFade.Evaluate(m_TimeFloat * 24) * MoonBrightness);
            ...
            if (FogType == FogTypeEnum.UnityFog)
            {
                ...
                m_CloudDomeMaterial.SetFloat(SHADER_useUniStormFog, 0);
            }
            else if (FogType == FogTypeEnum.UnistormFog)
            {
                ...
                m_CloudDomeMaterial.SetColor(SHADER_fogColor, CurrentFogColor);
                m_CloudDomeMaterial.SetColor(SHADER_sunColor, FogLightColor.Evaluate(m_TimeFloat));
                m_CloudDomeMaterial.SetFloat(SHADER_sunControl, SunControlCurve.Evaluate(m_TimeFloat * 24));
                m_CloudDomeMaterial.SetFloat(SHADER_moonControl, m_MoonLight.intensity);
                m_CloudDomeMaterial.SetVector(SHADER_sunVector, m_SunLight.transform.rotation * -Vector3.forward);
                m_CloudDomeMaterial.SetVector(SHADER_moonVector, m_MoonLight.transform.rotation * -Vector3.forward);
                m_CloudDomeMaterial.SetFloat(SHADER_sunIntensity, SunAtmosphericFogIntensity.Evaluate(m_TimeFloat * 24) * FogLightFalloff);
                m_CloudDomeMaterial.SetFloat(SHADER_moonIntensity, MoonAtmosphericFogIntensity.Evaluate(m_TimeFloat * 24) * FogLightFalloff);
            }
        }
        ...
        IEnumerator SunColorFadeSequence(float TransitionTime, float MaxValue)
        {
            ...
            while (LerpValue < MaxValue)
            {
                if (CurrentWeatherType.PrecipitationWeatherType == WeatherType.Yes_No.Yes)
                {
                    if (FogType == FogTypeEnum.UnistormFog)
                    {
                        yield return new WaitUntil(() => m_CloudDomeMaterial.GetFloat(SHADER_uCloudsCoverage) >= 0.45f);
                    }
                    else if (FogType == FogTypeEnum.UnityFog)
                    {
                        yield return new WaitUntil(() => m_CloudDomeMaterial.GetFloat(SHADER_uCloudsCoverage) >= m_ReceivedCloudValue);
                    }
        ...
        IEnumerator ColorFadeSequence(float TransitionTime, float MaxValue, Gradient FogGradientColor, Gradient CloudGradientColor)
        {
            ...
            {
                yield return new WaitUntil(() => m_CloudDomeMaterial.GetFloat(SHADER_uCloudsCoverage) >= 0.48f);
            }
        ...
        {
            float CurrentValue = m_CloudDomeMaterial.GetFloat(SHADER_uCloudsCoverage);
            ...
            while ((LerpValue > MaxValue && FadeOut) || (LerpValue < MaxValue && !FadeOut))
            {
                ...
                m_CloudDomeMaterial.SetFloat(SHADER_uCloudsCoverage, LerpValue);
        ...
        {
            float HorizonColorFadeStart = m_CloudDomeMaterial.GetFloat(SHADER_uHorizonColorFadeStart);
            float HorizonColorFadeEnd = m_CloudDomeMaterial.GetFloat(SHADER_uHorizonColorFadeEnd);
            float lerpValueColorStart;
            float LerpValueColorEnd = HorizonColorFadeEnd;

            float HorizonFadeStart = m_CloudDomeMaterial.GetFloat(SHADER_uHorizonFadeStart);
            float HorizonFadeEnd = m_CloudDomeMaterial.GetFloat(SHADER_uHorizonFadeEnd);
            float HorizonSunFadeEnd = m_CloudDomeMaterial.GetFloat(SHADER_uSunFadeEnd);
            float LerpValueStart = HorizonFadeStart;
            float LerpValueEnd = HorizonFadeEnd;
            float LerpSunValueEnd = HorizonSunFadeEnd;

            float HorizonBrightness = m_CloudDomeMaterial.GetFloat(SHADER_uCloudAlpha);
            float LerpValueHorizonBrightness;
            ...
            if (!FadeOut)
            {
                ...
                {
                    yield return new WaitUntil(() => m_CloudDomeMaterial.GetFloat(SHADER_uCloudsCoverage) >= m_ReceivedCloudValue - 0.05f);
                    ...
                    m_CloudDomeMaterial.SetFloat(SHADER_uHorizonColorFadeStart, lerpValueColorStart);
                    m_CloudDomeMaterial.SetFloat(SHADER_uHorizonColorFadeEnd, LerpValueColorEnd);
                    ...
                    m_CloudDomeMaterial.SetFloat(SHADER_uHorizonFadeStart, LerpValueStart);
                    m_CloudDomeMaterial.SetFloat(SHADER_uHorizonFadeEnd, LerpValueEnd);
                    m_CloudDomeMaterial.SetFloat(SHADER_uSunFadeEnd, LerpSunValueEnd);

                    LerpValueHorizonBrightness = Mathf.Lerp(HorizonBrightness, StormyHorizonBrightness, t * 5 / TransitionTime);
                    m_CloudDomeMaterial.SetFloat(SHADER_uCloudAlpha, LerpValueHorizonBrightness);
        ...
        IEnumerator FogFadeSequence(float TransitionTime, float MaxValue, bool FadeOut)
        {
            ...
            {
                if (QualitySettings.activeColorSpace == ColorSpace.Gamma)
                    yield return new WaitUntil(() => m_CloudDomeMaterial.GetFloat(SHADER_uCloudsCoverage) >= 0.6f);
                else
                    yield return new WaitUntil(() => m_CloudDomeMaterial.GetFloat(SHADER_uCloudsCoverage) >= 0.5f);
            }
        ...
        {
            yield return new WaitUntil(() => m_CloudDomeMaterial.GetFloat(SHADER_uHorizonColorFadeStart) >= 0);
        ...
        {
            float CurrentValue = m_CloudDomeMaterial.GetFloat(uCloudsBottom);
            ...
            while ((t / TransitionTime) < 1)
            {
                ...
                m_CloudDomeMaterial.SetFloat(uCloudsBottom, LerpValue);
        ...
        IEnumerator CloudTallnessSequence(float TransitionTime, float MaxValue)
        {
            ...
            {
                float CurrentValue = m_CloudDomeMaterial.GetFloat(SHADER_uCloudsHeight);
                float LerpValue;
                float t = 0;
                ...
                while ((t / TransitionTime) < 1)
                {
                    t += Time.deltaTime;
                    LerpValue = Mathf.Lerp(CurrentValue, MaxValue, t / TransitionTime);
                    m_CloudDomeMaterial.SetFloat(SHADER_uCloudsHeight, LerpValue);
        ...
        IEnumerator SoundFadeSequence(float TransitionTime, float MaxValue, AudioSource SourceToFade, bool FadeOut)
        {
            ...
            {
                if (QualitySettings.activeColorSpace == ColorSpace.Gamma)
                    yield return new WaitUntil(() => m_CloudDomeMaterial.GetFloat(SHADER_uCloudsCoverage) >= 0.59f);
                else
                    yield return new WaitUntil(() => m_CloudDomeMaterial.GetFloat(SHADER_uCloudsCoverage) >= m_ReceivedCloudValue);
            }
            else if (CurrentWeatherType.WaitForCloudLevel == WeatherType.Yes_No.Yes)
            {
                yield return new WaitUntil(() => m_CloudDomeMaterial.GetFloat(SHADER_uCloudsCoverage) >= (m_ReceivedCloudValue - 0.01f));
            }
        ...
        IEnumerator RainShaderFadeSequence(float TransitionTime, float MaxValue, bool FadeOut)
        {
            ...
            float CurrentValue = Shader.GetGlobalFloat(SHADER_wetnessStrength);
            float LerpValue = CurrentValue;
            float t = 0;
            ...
            while ((LerpValue > MaxValue && FadeOut) || (LerpValue < MaxValue && !FadeOut))
            {
                t += Time.deltaTime;
                LerpValue = Mathf.Lerp(CurrentValue, MaxValue, (t / TransitionTime));
                Shader.SetGlobalFloat(SHADER_wetnessStrength, LerpValue);
        ...
        IEnumerator SnowShaderFadeSequence(float TransitionTime, float MaxValue, bool FadeOut)
        {
            ...
            float CurrentValue = Shader.GetGlobalFloat(SHADER_snowStrength);
            float LerpValue = CurrentValue;
            float t = 0;
            ...
            while ((LerpValue > MaxValue && FadeOut) || (LerpValue < MaxValue && !FadeOut))
            {
                t += Time.deltaTime;
                LerpValue = Mathf.Lerp(CurrentValue, MaxValue, (t / TransitionTime));
                Shader.SetGlobalFloat(SHADER_snowStrength, LerpValue);
                yield return null;
            }
        }
        ...
        {
            float EdgeSoftnessValue = m_CloudDomeMaterial.GetFloat(SHADER_uCloudsBaseEdgeSoftness);
            float LerpedEdgeSoftnessValue ;

            float BaseSoftnessValue = m_CloudDomeMaterial.GetFloat(SHADER_uCloudsBottomSoftness);
            float LerpedBaseSoftnessValue ;

            float DetailStrengthValue = m_CloudDomeMaterial.GetFloat(SHADER_uCloudsDetailStrength);
            float LerpedDetailStrengthValue ;

            float DensityValue = m_CloudDomeMaterial.GetFloat(SHADER_uCloudsDensity);
            float LerpedDensityValue ;

            float CoverageBiasValue = m_CloudDomeMaterial.GetFloat(SHADER_uCloudsCoverageBias);
            float LerpedCoverageBiasValue ;
            ...
            while ((t / TransitionTime) < 1)
            {
                ...
                m_CloudDomeMaterial.SetFloat(SHADER_uCloudsBaseEdgeSoftness, LerpedEdgeSoftnessValue);

                //Base Softness
                LerpedBaseSoftnessValue = Mathf.Lerp(BaseSoftnessValue, MaxBaseSoftness, t / TransitionTime);
                m_CloudDomeMaterial.SetFloat(SHADER_uCloudsBottomSoftness, LerpedBaseSoftnessValue);

                //Detail Strength
                LerpedDetailStrengthValue = Mathf.Lerp(DetailStrengthValue, MaxDetailStrength, t / TransitionTime);
                m_CloudDomeMaterial.SetFloat(SHADER_uCloudsDetailStrength, LerpedDetailStrengthValue);

                //Density
                LerpedDensityValue = Mathf.Lerp(DensityValue, MaxDensity, t / TransitionTime);
                m_CloudDomeMaterial.SetFloat(SHADER_uCloudsDensity, LerpedDensityValue);

                //Coverage Bias
                LerpedCoverageBiasValue = Mathf.Lerp(CoverageBiasValue, MaxCoverageBias, t / TransitionTime);
                m_CloudDomeMaterial.SetFloat(SHADER_uCloudsCoverageBias, LerpedCoverageBiasValue);
        ...
        IEnumerator AtmosphericFogFadeSequence(float TransitionTime, float ShaderMaxValue, float CloudMaxValue)
        {
            ...
            float CloudsCurrentValue = m_CloudDomeMaterial.GetFloat(SHADER_fogBlendHeight);
            ...
            while ((t / TransitionTime) < 1)
            {
                ...
                m_CloudDomeMaterial.SetFloat(SHADER_fogBlendHeight, CloudsLerpValue);
        ...
        {
            float CurrentOpaqueValue = SunObjectMaterial.GetFloat(SHADER_opaqueY);
            float LerpOpaqueValue = CurrentOpaqueValue;
            float CurrentTransparentValue = SunObjectMaterial.GetFloat(SHADER_transparentY);
            ...
            while ((t / TransitionTime) < 1)
            {
                ...
                SunObjectMaterial.SetFloat(SHADER_opaqueY, LerpOpaqueValue);

                LerpTransparentValue = Mathf.Lerp(CurrentTransparentValue, TransparentValue, t / TransitionTime);
                SunObjectMaterial.SetFloat(SHADER_transparentY, LerpTransparentValue);
        ...
        void OnApplicationQuit()
        {
            ...
            Shader.SetGlobalFloat(SHADER_wetnessStrength, 0);
            Shader.SetGlobalFloat(SHADER_snowStrength, 0);
            Shader.SetGlobalFloat(SHADER_lightIntensity, 0);

            m_CloudDomeMaterial.SetFloat(SHADER_uHorizonColorFadeStart, 0);
            m_CloudDomeMaterial.SetFloat(SHADER_uHorizonColorFadeEnd, 0);
            m_CloudDomeMaterial.SetFloat(SHADER_uHorizonFadeStart, m_CloudFadeLevelStart);
            m_CloudDomeMaterial.SetFloat(SHADER_uHorizonFadeEnd, 0.18f);
            m_CloudDomeMaterial.SetFloat(SHADER_uSunFadeEnd, 0.045f);
            m_CloudDomeMaterial.SetFloat(SHADER_uCloudAlpha, 1);
            m_CloudDomeMaterial.SetFloat(SHADER_fogBlendHeight, 0.3f);
